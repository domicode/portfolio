...
(function($) {
	...
	$.fn.fullpage = function(options) {
		...
		options = $.extend({
			...
			'controlArrowColor': 'rgba(255,255,255,0.3)',
			'loopBottom': false,
			'loopTop': false,
			'loopHorizontal': true,
			'autoScrolling': true,
		...
		*/		
		...
		$(window).on('hashchange',function(){
			if(!isScrolling){
				...
				console.log(section)
				i = (i + 1) % images.length
				$("."+section).css({'background-image': 'url(../backgrounds/' + images[i] + ')'});
				console.log("i is "+i)
				// create a function which appends a random class in css
		...
		*/
		function addSlidesNavigation(section, numSlides){						
			...
			for(var i=0; i< numSlides; i++){			
				nav.find('ul').append('<li><a href="#"><span class="slidenavigation">Placeholder</span></a></li>');
			}
